  ...
  <main id="main">
    ...
    if(!isset($_POST["search"])){
      ...
      if(mysqli_connect_errno()){
        ...
        FROM tblactiviteit ac, tblauteur au WHERE ac.actAuteursID = au.auteurID AND ac.actAuteursID = ".$_SESSION["loginID"]." ORDER BY ac.actNm";
      ...
      if(mysqli_connect_errno()){
        ...
        if($_POST["filter"]=="naam"){
          $sql = "SELECT ac.actID, au.auteurNm, ac.actFoto, ac.actNm, ac.actBesch, ac.actPrijs 
          FROM tblactiviteit ac, tblauteur au WHERE ac.actAuteursID = au.auteurID AND ac.actAuteursID = ".$_SESSION["loginID"]." AND ac.actNm LIKE ? ORDER BY ac.actNm";
        }
        elseif($_POST["filter"]=="prijs"){
          $sql = "SELECT ac.actID, au.auteurNm, ac.actFoto, ac.actNm, ac.actBesch, ac.actPrijs
          FROM tblactiviteit ac, tblauteur au WHERE ac.actAuteursID = au.auteurID AND ac.actAuteursID = ".$_SESSION["loginID"]." AND ac.actPrijs LIKE ? ORDER BY ac.actNm";
        }
        elseif($_POST["filter"]=="auteur"){
          $sql = "SELECT ac.actID, au.auteurNm, ac.actFoto, ac.actNm, ac.actBesch, ac.actPrijs
          FROM tblactiviteit ac, tblauteur au WHERE ac.actAuteursID = au.auteurID AND ac.actAuteursID = ".$_SESSION["loginID"]." AND au.auteurNm LIKE ? ORDER BY ac.actNm";
        }
        elseif($_POST["filter"]=="type"){
          $sql = "SELECT ac.actID, au.auteurNm, ac.actFoto, ac.actNm, ac.actBesch, ac.actPrijs, ty.actType
          FROM tblactiviteit ac, tblauteur au, tbltypes ty WHERE ac.actAuteursID = au.auteurID AND ac.actAuteursID = ".$_SESSION["loginID"]." AND ac.actTypeID = ty.actTypeID AND ty.actType LIKE ? ORDER BY ac.actNm";
        }
        if($stmt = $mysqli->prepare($sql)){
