...
<!-- LOGO END --><!-- LINKS START --><div id="navipanellinks"><a href="index.php" title="Home"><img src="themes/dot.gif" title="Home" alt="Home" class="icon ic_b_home" /></a><a href="logout.php" class="logout disableAjax" title="Empty session data"><img src="themes/dot.gif" title="Empty session data" alt="Empty session data" class="icon ic_s_loggoff" /></a><a href="./doc/html/index.html" target="documentation" title="phpMyAdmin documentation"><img src="themes/dot.gif" title="phpMyAdmin documentation" alt="phpMyAdmin documentation" class="icon ic_b_docs" /></a><a href="./url.php?url=https%3A%2F%2Fdev.mysql.com%2Fdoc%2Frefman%2F5.7%2Fen%2Findex.html" target="mysql_doc" title="Documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_sqlhelp" /></a><a href="#" id="pma_navigation_settings_icon" title="Navigation panel settings"><img src="themes/dot.gif" title="Navigation panel settings" alt="Navigation panel settings" class="icon ic_s_cog" /></a><a href="#" id="pma_navigation_reload" title="Reload navigation panel"><img src="themes/dot.gif" title="Reload navigation panel" alt="Reload navigation panel" class="icon ic_s_reload" /></a></div><!-- LINKS ENDS --><img src="./themes/pmahomme/img/ajax_clock_small.gif" title="Loading…" alt="Loading…" style="visibility: hidden; display:none" class="throbber" /></div><div id="pma_navigation_tree" class="list_container synced highlight"><div class="pma_quick_warp"><div class="drop_list"><span title="Recent tables" class="drop_button">Recent</span><ul id="pma_recent_list"><li class="warp_link"><a href="tbl_recent_favorite.php?db=gip&amp;table=tblusersperact">`gip`.`tblusersperact`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=gip&amp;table=tbluser">`gip`.`tbluser`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=gip&amp;table=tbltypes">`gip`.`tbltypes`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=gip&amp;table=tblinteressesuser">`gip`.`tblinteressesuser`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=gip&amp;table=tblinteresse">`gip`.`tblinteresse`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=gip&amp;table=tblgemeente">`gip`.`tblgemeente`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=gip&amp;table=tbldatumtijd">`gip`.`tbldatumtijd`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=gip&amp;table=tblauteur">`gip`.`tblauteur`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=gip&amp;table=tblInteresse">`gip`.`tblInteresse`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=gip&amp;table=tblactiviteit">`gip`.`tblactiviteit`</a></li></ul></div><div class="drop_list"><span title="Favorite tables" class="drop_button">Favorites</span><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div><div class="clearfloat"></div><ul><!-- CONTROLS START --><li id="navigation_controls_outer"><div id="navigation_controls"><a href="#" id="pma_navigation_collapse" title="Collapse all"><img src="./themes/pmahomme/img/s_collapseall.png" title="Collapse all" alt="Collapse all" /></a><a href="#" id="pma_navigation_sync" title="Unlink from main panel"><img src="themes/dot.gif" title="Unlink from main panel" alt="Unlink from main panel" class="icon ic_s_link" /></a></div></li><!-- CONTROLS ENDS --></ul><div id='pma_navigation_tree_content'><ul><li class="first new_database italics"><div class='block'><i class='first'></i></div><div class='block '><a href='server_databases.php?server=1'><img src="themes/dot.gif" title="" alt="" class="icon ic_b_newdb" /></a></div><a class='hover_show_full' href='server_databases.php?server=1' title=''>New</a><div class="clearfloat"></div></li><li class="last database"><div class='block'><i></i><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.Z2lw</span><span class='hide vPath'>cm9vdA==.Z2lw</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus" /></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=gip&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db" /></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=gip' title='Structure'>gip</a><span class="dbItemControls"><a href="navigation.php?showUnhideDialog=1&amp;dbName=gip" class="showUnhide ajax"><img src="themes/dot.gif" title="Show hidden items" alt="Show hidden items" class="icon ic_show" /></a></span><div class="clearfloat"></div></li></ul></div></div><div id="pma_navi_settings_container"><div id="pma_navigation_settings"><div class="page_settings"><form method="post" action="export.php?db=&amp;table=&amp;server=1&amp;target=" class="config-form disableAjax"><input type="hidden" name="tab_hash" value="" /><input type="hidden" name="check_page_refresh"  id="check_page_refresh" value="" />
<input type="hidden" name="token" value="7f7f45642d938a99f71ae425f951d3c1" />
<input type="hidden" name="submit_save" value="Navi_panel" /><input type="hidden" name="token" value="7f7f45642d938a99f71ae425f951d3c1" /><ul class="tabs"    >
        ...
        <div class="content">
            <div class="console_message_container">
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        ...
                        targetdb="gip" targettable="tbluser">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> SELECT * FROM `tbluser` </span>
                                        ...
                                        <div class="message history collapsed hide select"
                        targetdb="gip" targettable="tblinteressesuser">
                        <div class="action_content">
            <span class="action collapse">
            Collapse                    </span>
            <span class="action expand">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> SELECT * FROM `tblinteressesuser` </span>
                    </div>
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> INSERT INTO `tblinteressesuser` (`userID`, `interesseID`) VALUES ('1', '1'), ('1', '2'), ('1', '3'); </span>
                    </div>
                                        <div class="message history collapsed hide select"
                        targetdb="gip" targettable="tblinteressesuser">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> SELECT * FROM `tbluser` </span>
                                        ...
                                        <div class="message history collapsed hide select"
                        targetdb="gip" targettable="tblauteur">
                        <div class="action_content">
            <span class="action collapse">
            Collapse                    </span>
            <span class="action expand">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> SELECT * FROM `tblauteur` </span>
                    </div>
                                        <div class="message history collapsed hide select"
                        targetdb="gip" targettable="tbldatumtijd">
                        <div class="action_content">
            <span class="action collapse">
            Collapse                    </span>
            <span class="action expand">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> SELECT * FROM `tbldatumtijd` </span>
                    </div>
                                        <div class="message history collapsed hide select"
                        targetdb="gip" targettable="tblgemeente">
                        <div class="action_content">
            <span class="action collapse">
            Collapse                    </span>
            <span class="action expand">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> SELECT * FROM `tblgemeente` </span>
                    </div>
                                        <div class="message history collapsed hide select"
                        targetdb="gip" targettable="tblinteresse">
                        <div class="action_content">
            <span class="action collapse">
            Collapse                    </span>
            <span class="action expand">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> SELECT * FROM `tblinteresse` </span>
                    </div>
                                        <div class="message history collapsed hide select"
                        targetdb="gip" targettable="tblinteressesuser">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> SELECT * FROM `tblinteressesuser` </span>
                                        ...
                                        <div class="message history collapsed hide select"
                        targetdb="gip" targettable="tbltypes">
                        <div class="action_content">
            <span class="action collapse">
            Collapse                    </span>
            <span class="action expand">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> SELECT * FROM `tbltypes` </span>
                    </div>
                                        <div class="message history collapsed hide select"
                        targetdb="gip" targettable="tbluser">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> SELECT * FROM `tbluser` </span>
                                        ...
                                        <div class="message history collapsed hide select"
                        targetdb="gip" targettable="tblusersperact">
                        <div class="action_content">
            <span class="action collapse">
            Collapse                    </span>
            <span class="action expand">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> SELECT * FROM `tblusersperact` </span>
                    </div>
